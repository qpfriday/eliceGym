            ...
            <div class="col-md-5 col-lg-8"><h4 class="mb-3">주문 정보</h4>
                ...
                <div class="row g-3">
                  ...
                  <div class="col-12">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="showCustomRequest"
                    ...
                    <div v-if="showCustomRequest">
                      <input type="text" class="form-control" id="customRequest" placeholder="배송 요청사항을 입력하세요 (100자 이내)" required
                             v-model="state.form.request">
                    </div>
                    <div v-else>
                      <select class="custom-select" v-model="state.form.request" required>
                ...
                <div class="my-3">
                  <div class="custom-control custom-radio">
                    <input id="card" type="radio" class="custom-control-input" checked required
                           v-model="state.form.payment" value="card">
                    <label class="custom-control-label" for="card">신용카드</label>
                  </div>
                  <div class="custom-control custom-radio">
                    <input id="bank" type="radio" class="custom-control-input" required
                           v-model="state.form.payment" value="bank">
                    <label class="custom-control-label" for="bank">무통장입금</label>
                  </div>
                </div>
                <label for="cc-number" class="form-label">카드 번호</label>
                <input
                    type="text" class="form-control" id="cc-number" v-model="state.form.cardNumber" required>
                <hr class="my-4">
